...
# Library includes
import applications.shared.modules.jsonrpclib
from applications.shared.modules.jsonrpclib import config
from applications.shared.modules.jsonrpclib import history
...
def dumps(params=[], methodname=None, methodresponse=None,
    ...
    if config.use_jsonclass == True:
        from applications.shared.modules.jsonrpclib import jsonclass
